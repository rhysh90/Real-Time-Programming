...
package Dio192defs is
   ...
   --   subtype Dac_Id is Cab_Type range 1..4;
   ...
   Turnout_Drive_Addr : constant array (Turnout_Idx range 0..2) of Unsigned_16 :=
   (Qa3_Addr, Qc3_Addr, Pb3_Addr);
   -- and state:
   Turnout_State_Addr : constant array (Turnout_Idx range 0..2) of Unsigned_16 :=
